...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("/api/v1/auth/email-code", s.handleAuthEmailCode)
	mux.HandleFunc("/api/v1/auth/email-code/verify", s.handleAuthVerifyEmailCode)
	mux.HandleFunc("/api/v1/auth/magic-link", s.handleAuthMagicLink)
	mux.HandleFunc("/api/v1/auth/magic-link/consume", s.handleAuthConsumeMagicLink)
