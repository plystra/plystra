...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("/api/v1/provider-request-contexts", s.handleProviderRequestContexts)
	mux.HandleFunc("/api/v1/provider-installations", s.handleProviderInstallations)
	mux.HandleFunc("/api/v1/provider-installations/", s.handleProviderInstallationSubroutes)
	mux.HandleFunc("/api/v1/provider-migration-revisions", s.handleProviderMigrationRevisions)
	mux.HandleFunc("/api/v1/provider-migration-revisions/", s.handleProviderMigrationRevisionSubroutes)
