...
const (
	// Label holds the string label denoting the resourceaction type in the database.
	...
	// FieldAuditDefault holds the string denoting the audit_default field in the database.
	FieldAuditDefault = "audit_default"
	...
	// Table holds the table name of the resourceaction in the database.
	Table = "resource_actions"
)

// Columns holds all SQL columns for resourceaction fields.
var Columns = []string{
	FieldID,
	FieldResourceTypeID,
	FieldKey,
...
var (
	...
	// DefaultAuditDefault holds the default value on creation for the "audit_default" field.
	DefaultAuditDefault bool
...
// OrderOption defines the ordering options for the ResourceAction queries.
...
// ByAuditDefault orders the results by the audit_default field.
func ByAuditDefault(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAuditDefault, opts...).ToFunc()
}
