...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldMetadata:
			values[i] = new([]byte)
		case group.FieldDepth, group.FieldSortOrder:
			values[i] = new(sql.NullInt64)
		case group.FieldID, group.FieldSpaceID, group.FieldParentGroupID, group.FieldName, group.FieldDisplayName, group.FieldPath, group.FieldStatus:
	...
	for i := range columns {
		...
		case group.FieldParentGroupID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.ParentGroupID = new(string)
				*_m.ParentGroupID = value.String
			}
