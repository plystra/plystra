...
func (_q *ActionExecutionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ActionExecutionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ActionExecutionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ActionExecutionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ActionExecutionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ActionExecutionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(actionexecution.FieldSpaceID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.ActionExecution.Query().
//		Select(actionexecution.FieldSpaceID).
//		Scan(ctx, &v)
...
func (_q *ActionExecutionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(actionexecution.Table, actionexecution.Columns, sqlgraph.NewFieldSpec(actionexecution.FieldID, field.TypeString))
	_spec.From = _q.sql
