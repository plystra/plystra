...
func (_c *SessionCreate) SetActiveSpaceID(v string) *SessionCreate {
	_c.mutation.SetActiveSpaceID(v)
	return _c
}

// SetNillableActiveSpaceID sets the "active_space_id" field if the given value is not nil.
func (_c *SessionCreate) SetNillableActiveSpaceID(v *string) *SessionCreate {
	if v != nil {
		_c.SetActiveSpaceID(*v)
	}
	return _c
}

// SetActiveMemberID sets the "active_member_id" field.
func (_c *SessionCreate) SetActiveMemberID(v string) *SessionCreate {
	_c.mutation.SetActiveMemberID(v)
	return _c
}

// SetNillableActiveMemberID sets the "active_member_id" field if the given value is not nil.
func (_c *SessionCreate) SetNillableActiveMemberID(v *string) *SessionCreate {
	if v != nil {
		_c.SetActiveMemberID(*v)
	}
	return _c
}

// SetActiveUserMemberID sets the "active_user_member_id" field.
func (_c *SessionCreate) SetActiveUserMemberID(v string) *SessionCreate {
	_c.mutation.SetActiveUserMemberID(v)
	return _c
}

// SetNillableActiveUserMemberID sets the "active_user_member_id" field if the given value is not nil.
func (_c *SessionCreate) SetNillableActiveUserMemberID(v *string) *SessionCreate {
	if v != nil {
		_c.SetActiveUserMemberID(*v)
	}
	return _c
}

// SetAccessTokenHash sets the "access_token_hash" field.
func (_c *SessionCreate) SetAccessTokenHash(v string) *SessionCreate {
	_c.mutation.SetAccessTokenHash(v)
	return _c
}
...
func (_c *SessionCreate) SetRefreshExpiresAt(v time.Time) *SessionCreate {
...
func (_c *SessionCreate) check() error {
	...
	if _, ok := _c.mutation.AccessTokenHash(); !ok {
		return &ValidationError{Name: "access_token_hash", err: errors.New(`ent: missing required field "Session.access_token_hash"`)}
	}
	if v, ok := _c.mutation.AccessTokenHash(); ok {
	...
	if _, ok := _c.mutation.RefreshExpiresAt(); !ok {
		return &ValidationError{Name: "refresh_expires_at", err: errors.New(`ent: missing required field "Session.refresh_expires_at"`)}
	}
...
func (_c *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ActiveSpaceID(); ok {
		_spec.SetField(session.FieldActiveSpaceID, field.TypeString, value)
		_node.ActiveSpaceID = &value
	}
	if value, ok := _c.mutation.ActiveMemberID(); ok {
		_spec.SetField(session.FieldActiveMemberID, field.TypeString, value)
		_node.ActiveMemberID = &value
	}
	if value, ok := _c.mutation.ActiveUserMemberID(); ok {
		_spec.SetField(session.FieldActiveUserMemberID, field.TypeString, value)
		_node.ActiveUserMemberID = &value
	}
	if value, ok := _c.mutation.AccessTokenHash(); ok {
