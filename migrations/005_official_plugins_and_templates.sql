...
INSERT INTO plugin_settings_definitions (id, plugin_id, key, value_type, default_value, description, scope, metadata) VALUES
	('psd_webhooks_delivery_timeout_ms', 'plugin_webhooks', 'delivery_timeout_ms', 'integer', '5000'::jsonb, 'Webhook delivery timeout.', 'space', '{}'),
	('psd_api_keys_max_key_ttl_days', 'plugin_api_keys', 'max_key_ttl_days', 'integer', '90'::jsonb, 'Maximum API key lifetime in days.', 'space', '{}'),
	('psd_notifications_default_channel', 'plugin_notifications', 'default_channel', 'string', 'null'::jsonb, 'Default notification channel key.', 'space', '{}'),
	('psd_moderation_auto_hide_threshold_v1', 'plugin_moderation', 'auto_hide_threshold', 'integer', '5'::jsonb, 'Hide content after this many open reports.', 'space', '{}')
